...
class UserDashLayout extends Component {
  render(){
          ...
          <Transition in={this.props.visible} timeout={durationButton}>
            {(state) => (
              <div
                ...
                {this.props.termos && <p className="termos">Ao clicar em prosseguir estarei ciente que minha assinatura será usada somente para contratação do plano de saúde que escolhi e depois será automaticamente destruída.</p>}
