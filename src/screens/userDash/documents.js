...
class Identity extends React.Component {
  constructor(props){
    super(props)
    const files = [{name: "RG (frente)", id: "identityFront"}, {name: "RG (verso)", id: "identityBack"}, {name: "Comprovante de Residência", id: "residenceComprovant"}]
    this.state = {
      errorMessage: '',
      blink: '',
      visible: false,
